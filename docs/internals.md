...
| `"UU/a/{k}"`                           | $\sum\limits_i(\mathbf{u}_i^{(k)}\cdot\mathbf{u}_i^{(k)})$                                                                                           | 0    | $k = 0\ldots2l$                    |
| `"TT/a/{k}"`                           | $\sum\limits_i(\mathbf{t}_i^{(k)}\cdot\mathbf{t}_i^{(k)})$                                                                                           | 0    | $k = 0, 1$                         |
| `"UT/a/{k}"`                           | $\sum\limits_i(\mathbf{u}_i^{(k)}\cdot\mathbf{t}_i^{(k)})$                                                                                           | 0    | $k = 0, 1$                         |
| `"UU/b/{k}"`                           | $\sum\limits_{i<j}(\mathbf{u}_i^{(k)}\cdot\mathbf{u}_j^{(k)})$                                                                                       | 0    | $k = 0\ldots2l$                    |
| `"TT/b/{k}"`                           | $\sum\limits_{i<j}(\mathbf{t}_i^{(k)}\cdot\mathbf{t}_j^{(k)})$                                                                                       | 0    | $k = 0, 1$                         |
| `"UT/b/{k}"`                           | $\sum\limits_{i<j}(\mathbf{u}_i^{(k)}\cdot\mathbf{t}_j^{(k)})$                                                                                       | 0    | $k = 0, 1$                         |
| `"UUTT/b/{ku1},{ku2},{kt1},{kt2},{k}"` | $\sum\limits_{i<j}(\\{\mathbf{u}_i^{(ku_1)}\times\mathbf{u}_j^{(ku_2)}\\}^{(k)} \cdot \\{\mathbf{t}_i^{(kt_1)}\times\mathbf{t}_j^{(kt_2)}\\}^{(k)})$ | 0    | $ku_i = 0\ldots2l$, $kt_i = 0, 1$  |
| `"UUU/c/{k1},{k2},{k3}"`               | $\sum\limits_{i<j<k}(\mathbf{u}_i^{(k_1)}\cdot\mathbf{u}_j^{(k_2)}\cdot\mathbf{u}_k^{(k_3)})$                                                        | 0    | $k_i = 0\ldots2l$                  |
