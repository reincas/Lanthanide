...
REDH3 = [0, 0, 0, 0, 0, 0, 0, 4.199999999999997, 3.8394589220500973e-32, -1.6886972623186727e-17, 0, 0, 0]
...
def test_reduced():
    ...
    red = reduced_matrix(ion, "H3/2", Coupling.SLJ)
    assert pytest.approx(red[:, 7], rel=1e-9) == REDH3
    #print(", ".join(map(str, red[:, 7])))
